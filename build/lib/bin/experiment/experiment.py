...
import experiments.curl_chaos.curl_exec_chaos.experiment.curl_exec_chaos as experiment
...
def main():
	...
	parser.add_argument("-name", action='store', default="chaos", dest="name", help="Chaos experiment for execution")
